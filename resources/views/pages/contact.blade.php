...
@section('content')
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-3 gap-8 mb-16">
                <!-- WhatsApp -->
                <a href="https://wa.me/6281226110198" target="_blank" class="group">
                    <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-3xl p-8 text-center card-hover h-full">
                        <div class="w-20 h-20 bg-green-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform">
                        ...
                        <span class="text-green-600 font-bold text-lg">+62 812 2611 0198</span>
                    </div>
                </a>
                
                <!-- Email -->
                <a href="mailto:hello@happyshop.id" class="group">
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 text-center card-hover h-full">
                        <div class="w-20 h-20 bg-primary-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform">
                        ...
                        <span class="text-primary-600 font-bold text-lg">hello@happyshop.id</span>
                    </div>
                </a>
                
                <!-- Location -->
                <div class="group">
                    <div class="bg-gradient-to-br from-pink-50 to-pink-100 rounded-3xl p-8 text-center card-hover h-full">
                        <div class="w-20 h-20 bg-secondary-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform">
                        ...
                        <span class="text-secondary-600 font-bold">Jl. Mainan Bahagia No. 123<br>Jakarta Selatan</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-8 max-w-2xl mx-auto">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center p-4 bg-white rounded-2xl">
                        ...
                        <p class="text-primary-600 font-bold">09:00 - 21:00 WIB</p>
                    </div>
                    <div class="text-center p-4 bg-white rounded-2xl">
                        <p class="font-semibold text-gray-900">Sabtu - Minggu</p>
                        <p class="text-primary-600 font-bold">10:00 - 22:00 WIB</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-20 bg-gradient-to-r from-secondary-500 to-primary-500 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="https://wa.me/6281226110198?text={{ urlencode('Halo, saya butuh bantuan untuk memilih mainan') }}" target="_blank" class="inline-flex items-center px-8 py-4 bg-white text-primary-600 font-bold rounded-full hover:bg-gray-100 transform hover:scale-105 transition-all shadow-lg">
